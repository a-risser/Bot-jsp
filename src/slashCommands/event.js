module.exports = {
    name: 'event',
    description: 'Faire un event pour proposer une session de jeu. Ajoutez la date pour les calls dans plus de 24h.',
    usage: '<prefix>event [@jeu] [hour] [date]', //OPTIONAL (for the help cmd)
